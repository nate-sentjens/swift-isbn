...
- **One type:** `ISBN` parses either written form (hyphen/space-tolerant, `X` check character) and holds canonical 13 digits. `ISBN("0201896834") == ISBN("9780201896831")`.
...
```swift
if case .printBook(let isbn) = ASINClassification(of: "0201896834") {
  String(describing: isbn)    // "9780201896831"
  isbn.isbn10String           // "0201896834"
}
```
